...
public class Country implements Parcelable
{
    ...
    protected Country(Parcel in) {
        ...
        in.readList(this.currencies, (be.technofuturtic.mobile.democonsowebapi.model.Currency.class.getClassLoader()));
        in.readList(this.languages, (be.technofuturtic.mobile.democonsowebapi.model.Language.class.getClassLoader()));
        ...
        in.readList(this.regionalBlocs, (be.technofuturtic.mobile.democonsowebapi.model.RegionalBloc.class.getClassLoader()));
     ...
     * @param currencies
     */
    public Country(String name, List<String> topLevelDomain, String alpha2Code, String alpha3Code, List<String> callingCodes, String capital, List<String> altSpellings, String region, String subregion, int population, List<Double> latlng, String demonym, double area, Object gini, List<String> timezones, List<String> borders, String nativeName, String numericCode, List<Currency> currencies, List<Language> languages, Translations translations, String flag, List<RegionalBloc> regionalBlocs, String cioc) {
        super();
        this.name = name;
